...
2. **Deutsch Probe** — Perturbs input constraints, has councilors predict the new answer, computes ground truth via symbolic code, and scores alignment. An LLM judge evaluates mechanism quality (whether reasoning is mathematically coherent, not just numerically correct).
